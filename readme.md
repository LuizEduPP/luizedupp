...
- **What I build:** enterprise full-stack apps, AI research tooling, MCP servers, browser extensions, desktop apps, embedded firmware, CLI utilities  
...
| 🧩 | [**Rememb**](https://github.com/LuizEduPP/Rememb) | Persistent memory for AI agents — local, portable, zero config. Works with Cursor, Windsurf, Claude via MCP. `Python · FastAPI · SQLite` |
